...
Adding a class in JS
1. className: div.className = "container";
  - fügt eine Klasse als String in html-class hinzu
2. classList: div.classList.add("container");
  - Methoden: 
      - add(String)
      - remove(String)
      - item(Number): Rückgabewert nach Index in der Sammlung
      - toggle(String)
      - contains(String)
