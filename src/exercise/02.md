...
## 📝 Your Notes
--> Erstellt ein Reactelement mit Typ h1, einer id von 1 und dem Text "Hello World!":
    const element = React.createElement("h1", {id: 1}, "Hello World!");
    ReactDOM.render(element, rootElement); 

--> Mit React kann man Reactelemente erstellen und ReactDOM ist dafür zuständig, dass diese Elemente im Browser angezeigt werden. 
